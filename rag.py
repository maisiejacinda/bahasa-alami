...
Original file is located at
    https://colab.research.google.com/drive/1bmuk4HvVVuYKfgKPGFo02YSdUEc5gua0
"""

!pip install langchain langchain-community langchain-openai pypdf faiss-cpu tiktoken streamlit
...
import urllib
print("Password Anda adalah:", urllib.request.urlopen('https://ipv4.icanhazip.com').read().decode('utf8').strip())